...
bot = telebot.TeleBot('7316039586:AAEj1W1BGDfRGV2AtAC8uHL86XnHvveDV5g')

# Admin user IDs
admin_id = ["", "1355294296", "6194332747", "1694578202"]
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to Your Home, {user_name}! PAID to Explore.
